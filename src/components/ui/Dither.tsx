...
import { useRef, useState, useEffect, forwardRef, useMemo, memo } from 'react';
...
function DitherComponent({
    ...
    useEffect(() => {
        const checkMobile = () => {
            ...
            setIsMobile(hasTouchScreen || isCoarsePointer || isNoHover);
        };
        checkMobile();
...
export default memo(DitherComponent);
