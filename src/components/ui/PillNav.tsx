...
const PillNav: React.FC<PillNavProps> = ({
    ...
    // Remove complex ref merge for simplicity in Next.js Link
    ...
    useEffect(() => {
        ...
        // Simplified initial load animation logic
    ...
    return (
        <div className={`fixed top-[1em] z-[1000] w-full left-0 md:w-auto md:left-auto ${className}`}>
            <nav
